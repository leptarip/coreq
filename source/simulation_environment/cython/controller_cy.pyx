...
import numpy as np
import carla
from source.simulation_environment.cython.misc_cy import get_speed
...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, waypoint):
        ...
        #print('Throttle = {0}, Brake = {1}'.format(control.throttle, control.brake))
...
class PIDLongitudinalController():
    ...
    def __init__(self, vehicle, K_P=1.0, K_I=0.0, K_D=0.0, dt=0.03):
        ...
        #print("PID delta_t:{0}".format(self._dt))
    ...
    def run_step(self, target_speed, debug=False):
        ...
        if debug:
            print('Current speed = {0}, Target speed = {1}'.format(current_speed, target_speed))
